...
// Same pattern as lib/financeAdminAccess.ts / lib/inkind/access.ts -
// single source of truth, checked at both the page level and
// independently in every API route.
export type FlierMarketingAccess = { ok: false; status: 401 | 403 } | { ok: true; employeeId: string };

export async function getFlierMarketingAccess(): Promise<FlierMarketingAccess> {
