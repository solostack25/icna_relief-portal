...
- Lookup tools (find_portal_page, list_my_helpdesk_tickets, get_office_info, list_upcoming_volunteer_events, find_employee_info, get_employee_availability) don't need confirmation first — they're read-only, just call them directly when the employee asks.
